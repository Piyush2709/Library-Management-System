...
<main id="main" class="main">
   ...
   <div class="col-12">
              <div class="card recent-sales overflow-auto">
                  ...
                  <div class="card-body">
                  <h5 class="card-title">Borrow Request <span>| Today</span></h5>
            ...
            %>
            <form action="accepted_borrow" method="POST">
        ...
        <td><select name="status">
                    <option value="Borrow Accept">Borrow Accept</option>
                    <option value="Borrow Canceled">Borrow Canceled</option> 
                  </select>
        </td>
