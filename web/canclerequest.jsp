...
<main id="main" class="main">
   ...
   <div class="col-12">
              <div class="card recent-sales overflow-auto">
                  ...
                  <div class="card-body">
                  <h5 class="card-title">Canceled Borrow<span>| Today</span></h5>
            ...
            try {
              ...
              String sql = "select * from cancelled_borrow";
              ResultSet rs = st.executeQuery(sql);
              while (rs.next()) {
                String cancelled_id = rs.getString("cancelled_id");
            %>
            <form action="update_order" method="POST">
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="cancelled_id" value="<%=rs.getString("cancelled_id")%>" >   
