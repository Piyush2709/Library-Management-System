        ...
        <div class="row">
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    <label for="Inputcollegename">Book Name</label>
                    <input type="text" class="form-control" name="bookname" placeholder="Enter Book name" required="">
                  </div>
                </div>
                        <div class="col-sm-6">
                  <div class="form-group">
                    <label for="Inputcollegename">Book Author</label>
                    <input type="text"  class="form-control" name="bookauthor" placeholder="Enter Author" required="">
                  </div>
                </div>
                ...
                <div class="col-sm-6"><br>
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="" name="book_img" required="">
                       ...
                       <div class="col-sm-6"><br>   
                  <div class="form-group">
                    <label for="exampleInputFile">Book Category</label>
                          ...
                          }catch(Exception ex)
{
                    ...
                    <div class="col-sm-6"><br>
                  <div class="form-group">
                    <label for="Inputcollegename">Number Of Copies</label>
                    <input type="number" class="form-control" name="copies"  required="">
                  </div>
                </div> 
                        <div class="col-sm-6">
                  <div class="form-group"><br>
                    <label for="Inputcollegename">Book Price</label>
                    <input type="text" maxlength="10" class="form-control" name="price" placeholder="Enter Price" required="">
                  </div>
                </div>
              </div>
                  ...
                  <div class="form-group"><br>
                        ...
                        <textarea name="book_description" class="form-control" rows="3" placeholder="Enter Description....." required=""></textarea>
                      </div>
                ...
                <div class="col-md-2">
                    <a href="View_menu.jsp" class="btn btn-warning" >Edit</a>
                </div>
